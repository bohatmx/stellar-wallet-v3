...
import 'package:stellar_wallet_v3/util/circles.dart';
...
class SplashPageState extends State<SplashPage>
          ...
          child: new Stack(
            ...
            children: <Widget>[
              new Transform(
                transform: matrix1,
                child: new Circle(
                    color: theme.primaryColor, diameter: circleDiameter),
              ),
              new Transform(
                transform: matrix2,
                child: new Opacity(
                  opacity: 0.8,
                  child: new Circle(
                      color: theme.accentColor, diameter: circleDiameter),
                ),
              )
            ],
          ),
  ...
  void showLandingPage() {
    new Future.delayed(new Duration(milliseconds: 500))
        .then((_) => Navigator.of(context).pushNamed("/account"));
  }
}
